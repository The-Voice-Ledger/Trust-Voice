  ...
  return (
    ...
    >
      ...
      <div className="relative h-36 flex items-center justify-center overflow-hidden" style={{ background: `linear-gradient(135deg, ${accent.from}0A, ${accent.to}08)` }}>
        ...
        {/* NGO name */}
        {campaign.ngo_name && (
          <span className="absolute bottom-3 left-3 bg-white/80 backdrop-blur-sm text-xs px-2.5 py-1 rounded-lg font-medium shadow-sm flex items-center gap-1" style={{ color: accent.from }}>
            {campaign.ngo_name}
