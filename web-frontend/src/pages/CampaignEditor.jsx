...
export default function CampaignEditor() {
  ...
  return (
    <PageBg pattern="topography" colorA="#0D9488" colorB="#10B981">
    <div className="max-w-2xl mx-auto px-4 py-6">
      <div className="flex items-center justify-between mb-6">
        <Link to="/my-projects" className="inline-flex items-center gap-1 text-sm text-emerald-600 hover:underline">
      ...
      <PageHeader icon={HiOutlineMapPin} title="Edit Campaign" subtitle={campaign?.title} accentColor="green" bespoke="topography" />
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="text" value={form.title} onChange={(e) => set('title', e.target.value)}
              className="w-full px-3 py-2.5 rounded-xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none transition text-sm" />
          </div>
          <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select value={form.category} onChange={(e) => set('category', e.target.value)}
                className="w-full px-3 py-2.5 rounded-xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none transition text-sm capitalize">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input type="text" placeholder="-1.286,36.817" value={form.location_gps} onChange={(e) => set('location_gps', e.target.value)}
                  className="flex-1 px-3 py-2.5 rounded-xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none transition text-sm" />
      ...
      <div className="flex flex-wrap gap-2">
        <Link to={`/campaign/${id}/milestones`} className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-green-50 text-green-700 text-xs font-semibold hover:bg-green-100 transition border border-green-100">
