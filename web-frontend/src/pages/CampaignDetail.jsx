...
export default function CampaignDetail() {
  ...
  return (
    <PageBg pattern="topography" colorA="#10B981" colorB="#14B8A6">
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <div className="mb-6">
        {campaign.category && (
          <span className="inline-block bg-emerald-50 text-emerald-600 text-xs font-semibold px-2.5 py-0.5 rounded-full capitalize mb-2">
            {campaign.category}
          </span>
        )}
        ...
        {campaign.ngo_name && (
          <div className="flex items-center gap-2 mt-2 flex-wrap">
            <Link to={`/ngo/${campaign.ngo_id}`} className="inline-flex items-center gap-1.5 text-sm text-gray-600 hover:text-emerald-600 transition font-medium">
            ...
            {campaign.ngo_website_url && (
              <a
                ...
                className="inline-flex items-center gap-1 text-[11px] text-gray-400 hover:text-emerald-500 transition"
              >
      ...
      {linkedProject && (
        <Link
          ...
          className="group flex items-center gap-3 mb-6 px-4 py-3 rounded-2xl bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200/60 hover:border-emerald-300 transition-all hover:shadow-md"
        >
      ...
      {/* Progress */}
        ...
        <svg className="absolute -top-1 -right-1 w-20 h-20 pointer-events-none" viewBox="0 0 80 80" fill="none">
          <path d="M45 35 L57 10 L69 35" stroke="#10B981" strokeWidth="0.5" opacity="0.05" />
          <path d="M45 35 L69 35" stroke="#10B981" strokeWidth="0.4" opacity="0.04" />
          <circle cx="57" cy="10" r="2" fill="#10B981" opacity="0.06" />
        </svg>
      ...
      {treasury && (
        <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-100 p-4 sm:p-5 mb-6 overflow-hidden">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
            ...
            <div>
              <p className="text-lg font-bold text-emerald-600">${fmt(treasury.total_released_usd)}</p>
      ...
      {updates.length > 0 && (
        <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-100 p-4 sm:p-5 mb-6 overflow-hidden">
          ...
          <h3 className="text-sm font-semibold text-gray-800 flex items-center gap-1.5 mb-3">
            <HiOutlineDocumentText className="w-4 h-4 text-green-600" /> Project Updates
          </h3>
          <div className="space-y-4">
            {updates.map((u) => (
              <div key={u.id} className="border-l-2 border-green-200 pl-3">
      ...
      {/* Donate section */}
        ...
        {!showDonate ? (
          <button
            ...
            className="w-full py-3 rounded-xl bg-emerald-600 text-white font-semibold hover:bg-emerald-700 transition text-center"
          >
        ...
        <Link
          ...
          className="mt-4 flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-emerald-50 text-emerald-700 text-sm font-medium hover:bg-emerald-100 transition-all border border-emerald-100"
        >
