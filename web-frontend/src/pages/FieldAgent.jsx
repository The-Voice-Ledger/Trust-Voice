...
export default function FieldAgent() {
  ...
  return (
    <PageBg pattern="blueprint" colorA="#14B8A6" colorB="#F59E0B">
    <div className="max-w-2xl mx-auto px-4 py-8">
      <PageHeader icon={HiOutlineCamera} title={t('field_agent.title')} subtitle={t('field_agent.subtitle')} accentColor="green" bespoke="camera" />
      ...
      <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-100 p-4 sm:p-6 mb-6 overflow-hidden">
        ...
        <svg className="absolute top-2 right-2 w-24 h-24 pointer-events-none" viewBox="0 0 96 96" fill="none">
          <circle cx="65" cy="28" r="16" stroke="#14B8A6" strokeWidth="0.5" opacity="0.05" />
          <path d="M57 28 L65 20 L73 28 L65 36 Z" stroke="#14B8A6" strokeWidth="0.4" opacity="0.04" />
          <circle cx="65" cy="28" r="6" stroke="#14B8A6" strokeWidth="0.3" strokeDasharray="2 2" opacity="0.04" />
          <circle cx="65" cy="12" r="1.5" fill="#14B8A6" opacity="0.05" />
          <path d="M65 12 L65 20" stroke="#14B8A6" strokeWidth="0.3" opacity="0.04" />
        </svg>
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-4">
              <p className="text-sm text-green-700 font-medium">{t('field_agent.earn_note')}</p>
            </div>
          </div>
        )}
      </div>
